...
def attackCheck(classifier):
  ...
  return DeepFool_x_test, FastGradientMethod_x_test
...
def do_multitest_exp(problem, modelfunction, loadWeightsFrom):
    ...
    classifier = TensorFlowV2Classifier(model=model, loss_object=tf.keras.losses.CategoricalCrossentropy(), nb_classes=num_classes, input_shape=input_shape) # Atack classifier
...
def do_multitest_no_augment(problem, modelfunction, loadWeightsFrom):
    ...
    model.load_weights(loadWeightsFrom)
    classifier = TensorFlowV2Classifier(model=model, loss_object=tf.keras.losses.CategoricalCrossentropy(), nb_classes=num_classes, input_shape=input_shape) # Atack classifire
    DF_x_test, FGM_x_test = attackCheck(classifier)
    print('linear ...')
...
def TestCifar10():
    ...
    exp_multitest['linear'] = do_multitest_exp(db, net1_expectation_binomial_residual_network,  # linear
                                               loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_t1_net1_expectation_binomial_residual_network/e_weights/00000210.h5')

    print('exp: t1')
    exp_multitest['t1'] = do_multitest_exp(db, net1_expectation_binomial_residual_network,  # t1
                                           loadWeightsFrom='ok_results/StartAt_190506-100246_cifar10_t1_net1_expectation_binomial_residual_network/e_weights/00000190.h5')
    print('exp: t2')
    exp_multitest['t2'] = do_multitest_exp(db, net1_expectation_binomial_residual_network,  # t2
                                           loadWeightsFrom='ok_results/StartAt_190506-100246_cifar10_t2_net1_expectation_binomial_residual_network/e_weights/00000210.h5')
    print('exp: t3')
    exp_multitest['t3'] = do_multitest_exp(db, net1_expectation_binomial_residual_network,  # t3
                                           loadWeightsFrom='ok_results/StartAt_190506-100246_cifar10_t3_net1_expectation_binomial_residual_network/e_weights/00000160.h5')
    ...
    noaug_multitest['linear'] = do_multitest_no_augment(db, net2_bernoulli_residual_network,  # linear
                                                        loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_linear_net2_bernoulli_residual_network_no_augments/e_weights/00000080.h5')
    print('no_augment: t1')
    noaug_multitest['t1'] = do_multitest_no_augment(db, net2_bernoulli_residual_network,  # t1
                                                    loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_t1_net2_bernoulli_residual_network_no_augments/e_weights/00000220.h5')
    print('no_augment: t2')
    noaug_multitest['t2'] = do_multitest_no_augment(db, net2_bernoulli_residual_network,  # t2
                                                    loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_t2_net2_bernoulli_residual_network_no_augments/e_weights/00000240.h5')
    print('no_augment: t3')
    noaug_multitest['t3'] = do_multitest_no_augment(db, net2_bernoulli_residual_network,  # t3
                                                    loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_t3_net2_bernoulli_residual_network_no_augments/e_weights/00000240.h5')
    print('no_augment: t5')
    noaug_multitest['t5'] = do_multitest_no_augment(db, net2_bernoulli_residual_network,  # t5
                                                    loadWeightsFrom='ok_results/StartAt_190428-164814_cifar10_t5_net2_bernoulli_residual_network_no_augments/e_weights/00000110.h5')
...
def TestMNIST():
    ...
    exp_multitest['linear'] = do_multitest_exp(db, net1mnist_expectation_binomial_residual_network,  # linear
                                               loadWeightsFrom='ok_results/StartAt_190528-094208_mnist_linear_net1_expectation_binomial_residual_network/e_weights/00000070.h5'),

    print('exp: t1')
    exp_multitest['t1'] = do_multitest_exp(db, net1mnist_expectation_binomial_residual_network,  # t1
                                           loadWeightsFrom='ok_results/StartAt_190528-094208_mnist_t1_net1_expectation_binomial_residual_network/e_weights/00000120.h5'),
    print('exp: t2')
    exp_multitest['t2'] = do_multitest_exp(db, net1mnist_expectation_binomial_residual_network,  # t2
                                           loadWeightsFrom='ok_results/StartAt_190525-002923_mnist_t2_net1_expectation_binomial_residual_network/e_weights/00000160.h5'),
    print('exp: t3')
    exp_multitest['t3'] = do_multitest_exp(db, net1mnist_expectation_binomial_residual_network,  # t3
                                           loadWeightsFrom='ok_results/StartAt_190525-002923_mnist_t3_net1_expectation_binomial_residual_network/e_weights/00000200.h5'),
    print('exp: t4')
    exp_multitest['t4'] = do_multitest_exp(db, net1mnist_expectation_binomial_residual_network,  # t4
                                           loadWeightsFrom='ok_results/StartAt_190525-002923_mnist_t4_net1_expectation_binomial_residual_network/e_weights/00000140.h5'),
    ...
    noaug_multitest['linear'] = do_multitest_no_augment(db, net2mnist_bernoulli_residual_network,  # linear
                                                        loadWeightsFrom='ok_results/StartAt_190529-114807_mnist_linear_net2_bernoulli_residual_network_no_augments/e_weights/00000230.h5'),
    print('no_augment: t1')
    noaug_multitest['t1'] = do_multitest_no_augment(db, net2mnist_bernoulli_residual_network,  # t1
                                                    loadWeightsFrom='ok_results/StartAt_190528-094208_mnist_t1_net2_bernoulli_residual_network_no_augments/e_weights/00000120.h5'),
    print('no_augment: t2')
    noaug_multitest['t2'] = do_multitest_no_augment(db, net2mnist_bernoulli_residual_network,  # t2
                                                    loadWeightsFrom='ok_results/StartAt_190529-114807_mnist_t2_net2_bernoulli_residual_network_no_augments/e_weights/00000230.h5'),
    print('no_augment: t3')
    noaug_multitest['t3'] = do_multitest_no_augment(db, net2mnist_bernoulli_residual_network,  # t3
                                                    loadWeightsFrom='ok_results/StartAt_190529-114807_mnist_t3_net2_bernoulli_residual_network_no_augments/e_weights/00000040.h5'),
    print('no_augment: t5')
    noaug_multitest['t5'] = do_multitest_no_augment(db, net2mnist_bernoulli_residual_network,  # t5
                                                    loadWeightsFrom='ok_results/StartAt_190529-114807_mnist_t5_net2_bernoulli_residual_network_no_augments/e_weights/00000210.h5'),
